...
- Run the [Bump Version](.github/workflows/bump-version.yaml) workflow.
  - Give it a new release version. For example, if the current version is 1.2.3-pre.4, type in 1.2.3. This will cause a release to [crates.io](https://crates.io/crates/ironcore-documents).
